...
add wave -noupdate -label iX -radix hexadecimal /tb_tpu_mv_element/s_iX
add wave -noupdate -label iW -radix hexadecimal /tb_tpu_mv_element/s_iW
add wave -noupdate -label iLdW -radix hexadecimal /tb_tpu_mv_element/s_iLdW
add wave -noupdate -label iY -radix hexadecimal /tb_tpu_mv_element/s_iY
...
add wave -noupdate -label oY -radix hexadecimal /tb_tpu_mv_element/s_oY
add wave -noupdate -label oX -radix hexadecimal /tb_tpu_mv_element/s_oX
