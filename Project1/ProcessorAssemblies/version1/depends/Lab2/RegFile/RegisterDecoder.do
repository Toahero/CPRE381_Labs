...
add wave -noupdate -label CLK /tb_RegisterDecoder/CLK
...
add wave -noupdate -label s0 /tb_RegisterDecoder/s_0
add wave -noupdate -label s1 /tb_RegisterDecoder/s_1
add wave -noupdate -label s2 /tb_RegisterDecoder/s_2
add wave -noupdate -label s3 /tb_RegisterDecoder/s_3
add wave -noupdate -label s4 /tb_RegisterDecoder/s_4
...
add wave -noupdate -label output -radix hexadecimal /tb_RegisterDecoder/s_OUT

force s_4 0 0, 1 400 -repeat 800
force s_3 0 0, 1 200 -repeat 400
force s_2 0 0, 1 100 -repeat 200
force s_1 0 0, 1 50 -repeat 100
force s_0 0 0, 1 25 -repeat 50
